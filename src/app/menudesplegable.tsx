...
const MenuDesplegable = () => {
  ...
  return (
    ...
    <div className="flex items-center justify-end mr-2 h-46">
      ...
      {menuVisible && (
        <div
          className="absolute bottom-[5px] right-[2px] w-screen border-[2px] border-stone-700  bg-gradient-to-l from-blue-950 to-blue-900 rounded-[10px] shadow-2xl z-[100] transition duration-150 ease-out hover:ease-in md:w-[400px] md:h-[600px]"
